...
RSpec.describe RandomImagesController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # RandomImage. As you add validations to RandomImage, be sure to
  ...
  # RandomImagesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
